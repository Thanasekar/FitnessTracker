...
using RecommendationService.ApplicationServicesRegistry;
...
namespace RecommendationService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RecommentationDbContext>(options =>
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RecommendationService v1"));
